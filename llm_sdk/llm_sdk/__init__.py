...
class Small_LLM_Model:
    ...
    def get_path_to_vocab_file(self) -> str:
        ...
        vocab_path = hf_hub_download(repo_id=self._model_name,
    ...
    def get_path_to_merges_file(self) -> str:
        ...
        merges_path = hf_hub_download(repo_id=self._model_name,
    ...
    def get_path_to_tokenizer_file(self) -> str:
        ...
        tokenizer_path = hf_hub_download(repo_id=self._model_name,
